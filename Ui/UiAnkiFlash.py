...
# Form implementation generated from reading ui file '/Users/long.hoangly/Library/Application Support/Anki2/addons21/1129289384/Ui/UiAnkiFlash.ui'
#
...
class UiAnkiFlash(object):
    def setupUi(self, Dialog, version):
        ...
        self.sourceBox.setGeometry(QtCore.QRect(20, 224, 121, 111))
        font = QtGui.QFont()
        font.setBold(True)
        ...
        self.translatedToBox.setGeometry(QtCore.QRect(230, 224, 171, 151))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.importerBox.setGeometry(QtCore.QRect(440, 460, 421, 141))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.importProgressBar.setGeometry(QtCore.QRect(100, 90, 301, 31))
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        ...
        self.deckNameLbl.setGeometry(QtCore.QRect(20, 60, 81, 16))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.importBtn.setGeometry(QtCore.QRect(20, 90, 75, 31))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.deckNameTxt.setGeometry(QtCore.QRect(100, 50, 301, 31))
        self.deckNameTxt.setObjectName("deckNameTxt")
        self.ankiflashInfoBox = QtWidgets.QGroupBox(Dialog)
        self.ankiflashInfoBox.setGeometry(QtCore.QRect(10, 460, 421, 141))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.buycoffee.setGeometry(QtCore.QRect(20, 90, 391, 31))
        font = QtGui.QFont()
        ...
        self.inbox.setGeometry(QtCore.QRect(20, 70, 391, 16))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setBold(False)
        font.setItalic(False)
        ...
        self.support.setGeometry(QtCore.QRect(20, 50, 391, 16))
        font = QtGui.QFont()
        font.setFamily("MS Shell Dlg 2")
        font.setBold(False)
        font.setItalic(False)
    ...
    def retranslateUi(self, Dialog, version):
        ...
        self.buycoffee.setText(_translate("Dialog", "<html><head/><body><p>If you want to buy me a coffee: <br/><a href=\"https://www.buymeacoffee.com/longhoangly\">https://www.buymeacoffee.com/longhoangly</a></p></body></html>"))
