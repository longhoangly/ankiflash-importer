...
class UiGenerator(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.inputTxt.setPlaceholderText(
            _translate("Dialog", "Input your words"))
        self.generateBtn.setToolTip(_translate(
            "Dialog", "Generate flashcards for the input words"))
        ...
        self.allWordTypes.setToolTip(_translate(
            "Dialog", "If a word has more than one type (noun, adjective, verb...), AnkiFlash will create cards for all of them"))
        self.allWordTypes.setText(_translate("Dialog", "All word types?"))
        self.isOnline.setToolTip(_translate(
            "Dialog", "Usually, card sound will be downloaded to local computer. AnkiFlash provide an option to use online sound, your computer don\'t need to store sound file."))
        self.isOnline.setText(_translate("Dialog", "Online sound?"))
        self.cancelBtn.setToolTip(_translate(
            "Dialog", "Cancel flashcards generation process"))
        ...
        self.failureTxt.setPlaceholderText(
            _translate("Dialog", "Failure words"))
        self.ankiflashInfoBox.setTitle(_translate("Dialog", "AnkiFlash Info"))
        self.buycoffee.setText(_translate(
            "Dialog", "<html><head/><body><p>If you want to buy me a coffee: <a href=\"https://www.buymeacoffee.com/longhoangly\">https://www.buymeacoffee.com/longhoangly</a></p></body></html>"))
        self.inbox.setText(_translate(
            "Dialog", "Feel free to drop me a message if any issue or suggestion"))
        self.caption.setText(_translate(
            "Dialog", "Always beside and help you to learn vocabularies"))
        self.support.setText(_translate(
            "Dialog", "Support: <a href=\"https://www.facebook.com/ankiflashcom/inbox\" target=\"_blank\">https://www.facebook.com/ankiflashcom/inbox</a>"))
        self.importBtn.setToolTip(_translate(
            "Dialog", "Cick here to import / create new cards."))
        self.importBtn.setText(_translate("Dialog", "Import"))
        self.mappingBtn.setToolTip(_translate(
            "Dialog", "To update existing flashcards with mapping fields"))
